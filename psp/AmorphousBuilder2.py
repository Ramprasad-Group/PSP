    ...
    def Build(self):
        ...
        for i in self.Dataframe.index:
            ...
            mol = cob.Builder(
                ...
                Nunits_col=self.Nunits_col,
                Mwt_col=self.Mwt_col,
                define_BB_col=self.define_BB_col,
        ...
        for index, row in self.Dataframe.iterrows():
            ...
            smi_list += [str(smiles_each)] * NumConf

            NumConf_list.append(NumConf)
