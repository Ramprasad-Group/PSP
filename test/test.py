...
chain_builder = PB.Builder(df_smiles,ID_col='PID',SMILES_col='smiles_polymer', num_conf=1, Steps=50, Substeps=10, input_monomer_angles='low', input_dimer_angles='low', method='SA', n_cores=0)
